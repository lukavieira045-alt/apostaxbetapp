(function () {
  ...
  /* Correção da Roleta Cassino: ficha de aposta como chip real e bloqueio
     de navegação acidental ao tocar nas faixas da mesa. */
  if (/roleta-cassino\.html$/i.test(location.pathname)) {
    var rouletteFix = function () {
      ...
      style.textContent = `
        ...
        .ficha-aposta::before{
          ...
          inset:4px!important;
          border-radius:50%!important;
          background:radial-gradient(circle at 35% 30%,#fff,#e9e9e9 55%,#aaa 100%)!important;
        ...
        .ficha-aposta::after{
          ...
          inset:7px!important;
          border-radius:50%!important;
          border:1px dashed #b51e25!important;
        }
      `;
    ...
    if (document.readyState === 'loading') {
      document.addEventListener('DOMContentLoaded', rouletteFix);
    } else {
      rouletteFix();
    }
  }
