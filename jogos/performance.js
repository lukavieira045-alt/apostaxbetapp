(function () {
  ...
  /* =========================================================
     ROULETA 2 PRO — giro unico, sentidos opostos e parada real
     ========================================================= */
  ...
  if (isRoleta2) {
    ...
    pro.textContent = `
      ...
      .numero-roleta::before{content:""!important;position:absolute!important;inset:32px!important;border-radius:50%!important;border:3px solid rgba(245,205,119,.5)!important;box-shadow:0 0 0 5px rgba(34,17,5,.72),inset 0 0 20px rgba(0,0,0,.72)!important;pointer-events:none!important;z-index:1!important}
      .numero-roleta::after{content:""!important;position:absolute!important;inset:55px!important;border-radius:50%!important;border:1px solid rgba(255,220,130,.24)!important;pointer-events:none!important;z-index:1!important}
      .numero-roleta span{font-family:Georgia,"Times New Roman",serif!important;font-size:15px!important;font-weight:900!important;color:#fff!important;text-shadow:0 2px 3px #000,0 0 5px #000!important}
      .roleta-centro{width:136px!important;height:136px!important;border:8px solid #b97918!important;background:radial-gradient(circle at 34% 24%,#fff7ca 0%,#efc15f 18%,#b87818 43%,#683906 70%,#1b0b02 100%)!important;box-shadow:inset 0 0 18px #3b1c00,inset 0 0 3px rgba(255,255,255,.55),0 0 0 4px #e2b65b,0 0 0 7px #56310b,0 0 25px rgba(0,0,0,.9)!important}
      .roleta-centro::before{content:""!important;position:absolute!important;left:50%!important;top:50%!important;width:34px!important;height:34px!important;transform:translate(-50%,-50%)!important;border-radius:50%!important;border:4px solid #f4cf73!important;box-shadow:inset 0 0 8px #4a2606,0 2px 5px #000!important}
      .roleta-centro::after{content:"A"!important;font-size:42px!important;color:#fff4c4!important;text-shadow:0 2px 6px #000,0 0 10px rgba(255,218,120,.3)!important}
      .bola{width:20px!important;height:20px!important;background:radial-gradient(circle at 30% 25%,#fff 0%,#fff 34%,#e3e3e3 65%,#aaa 100%)!important;box-shadow:0 0 7px #fff,0 0 16px rgba(255,255,255,.95),0 0 28px rgba(255,255,255,.6),inset -2px -2px 3px rgba(0,0,0,.35)!important}
